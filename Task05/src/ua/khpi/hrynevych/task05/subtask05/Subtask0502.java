...
/**
 * Class organizing reading and writing using reentrant lock and
 * conditions.
 *
 * @author   Hrynevych Pavlo
 * @version  1.0, 03 Dec 2017
 */
public final class Subtask0502 {
	...
	/**
	 * The condition responsible for the possibility of reading from the buffer.
	 */
	private static final Condition NOT_WRITTEN = BUFFER_LOCK.newCondition();

	/**
	 * The condition responsible for the possibility of writing to the buffer.
	 */
	private static final Condition NOT_READ = BUFFER_LOCK.newCondition();
